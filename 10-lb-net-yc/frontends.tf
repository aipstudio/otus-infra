resource "yandex_compute_instance_group" "frontends" {
  ...
  depends_on = [ resource.local_file.metadata, yandex_resourcemanager_folder_iam_member.compute_editor, yandex_resourcemanager_folder_iam_member.load_balancer_editor ]
  instance_template {
